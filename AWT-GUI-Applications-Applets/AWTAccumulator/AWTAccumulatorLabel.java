...
public class AWTAccumulatorLabel extends Frame {
	...
	private Label tfOutput; // declare output display Label
	...
	private void initComponents() {
		...
		tfInput.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				tfInput.setText("");
				// display sum on the output Label
		...
		tfOutput.setText(sum + ""); // display sum on the output Label
		add(tfOutput); // "this" Frame adds the Label
